...
- Replaced the broken ASCII-art README banner with a clean header.
- Documented that `react-native-webview` is autolinked and must not be added to
  the Expo config `plugins` array.
